...
<div class="d-flex align-items-center mb-4">
  <div>
    <h1 class="mb-1">xxanael</h1>
    <p class="text-muted mb-0">Étudiant en Sécurité des Systèmes d'Information (SSI) @ HECM</p>
  </div>
</div>
...
Quand je ne suis pas derrière un terminal Kali, tu me trouveras probablement devant un anime, en train de jouer à *Zelda* ou *Nine Sols*, ou sur un terrain de basket.

Bienvenue dans mon dojo numérique. 🥷

---

### 🛠️ Stack & Domaines d'intérêt

- **CTF & Security :** OSINT, Web Exploitation, Digital Forensics.
- **Plateformes :** TryHackMe, Hack The Box, picoCTF, OverTheWire.
- **Environnement & Dev :** Kali Linux, C, C#, Python, Bash, Git.
